...
const CURRENT_MONTH = '202604'

let journals: Journal[] = [
  { distinct_number: 1, vesting_month: CURRENT_MONTH, spend_date: '20260403', spend_way: 'BANK_CTBC', spend_way_type: 'account',     spend_way_table: 'Account',     action_main: 'INC',  action_main_type: 'Income',   action_main_table: 'Code_Data', action_sub: 'INC_SAL',  action_sub_type: 'Income',   action_sub_table: 'Code_Data', spending: 80000, invoice_number: null, note: '4 月薪資' },
  { distinct_number: 2, vesting_month: CURRENT_MONTH, spend_date: '20260405', spend_way: 'BANK_CTBC', spend_way_type: 'account',     spend_way_table: 'Account',     action_main: 'FIX',  action_main_type: 'Fixed',    action_main_table: 'Code_Data', action_sub: 'FIX_RNT',  action_sub_type: 'Fixed',    action_sub_table: 'Code_Data', spending: -18000, invoice_number: null, note: '4 月房租' },
  { distinct_number: 3, vesting_month: CURRENT_MONTH, spend_date: '20260408', spend_way: 'CC_VISA',   spend_way_type: 'credit_card', spend_way_table: 'Credit_Card', action_main: 'FLT',  action_main_type: 'Floating', action_main_table: 'Code_Data', action_sub: 'FLT_FOOD', action_sub_type: 'Floating', action_sub_table: 'Code_Data', spending: -1280, invoice_number: 'AB-12345678', note: '聚餐' },
  { distinct_number: 4, vesting_month: CURRENT_MONTH, spend_date: '20260412', spend_way: 'CC_VISA',   spend_way_type: 'credit_card', spend_way_table: 'Credit_Card', action_main: 'FLT',  action_main_type: 'Floating', action_main_table: 'Code_Data', action_sub: 'FLT_TRP',  action_sub_type: 'Floating', action_sub_table: 'Code_Data', spending: -540,  invoice_number: null, note: '高鐵' },
  { distinct_number: 5, vesting_month: CURRENT_MONTH, spend_date: '20260420', spend_way: 'BANK_CTBC', spend_way_type: 'account',     spend_way_table: 'Account',     action_main: 'INV',  action_main_type: 'Invest',   action_main_table: 'Code_Data', action_sub: 'INV_STK',  action_sub_type: 'Invest',   action_sub_table: 'Code_Data', spending: -15000, invoice_number: null, note: '台股定期定額' },
  { distinct_number: 6, vesting_month: '202603',     spend_date: '20260318', spend_way: 'BANK_CTBC', spend_way_type: 'account',     spend_way_table: 'Account',     action_main: 'FIX',  action_main_type: 'Fixed',    action_main_table: 'Code_Data', action_sub: 'FIX_UTL',  action_sub_type: 'Fixed',    action_sub_table: 'Code_Data', spending: -2400, invoice_number: null, note: '電費' },
]
